"""
Django settings for gateways project.
...
SECRET_KEY = 'django-insecure--=vr@z13m6e!11ou%@ctn&2d7xup9(muwlcb_d56ns)v^a-@sw'
...
WSGI_APPLICATION = 'gateways.wsgi.application'
