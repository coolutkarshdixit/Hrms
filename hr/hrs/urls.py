...
urlpatterns = [
    ...
    path('employee/edit/<str:employee_id>/', views.edit_employee, name='edit_employee'),
    ...
    path('salary_details_list/', views.salary_details_list, name='salary_details_list'),
    path('salary/edit/<str:employee_id>/', views.edit_salary_add, name='edit_salary_add'),  # This must match the name
