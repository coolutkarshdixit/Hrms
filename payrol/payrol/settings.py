"""
Django settings for payrol project.
...
SECRET_KEY = 'django-insecure-faif=6p%sip5#2u$$y)lve)1vu!7iy75uahsq&z=kvjo325y^9'
...
WSGI_APPLICATION = 'payrol.wsgi.application'
